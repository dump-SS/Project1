/**
 * Threads —— 源自 React Bits（https://reactbits.dev，MIT + Commons Clause：
 * 产品内可用，禁止打包成组件库转售），-TS-TW 变体原样落盘。
 * 用于落地页第二屏 → 隐私安全之间的过渡带背景（2026-09-25 Skyer 指定：
 * amplitude 1 / distance 0，品牌蓝线条）。
 * ogl 实现（已在 deps，零新增）；React 18 兼容已验证（useEffect/useRef only）。
 * 内置工程化：DPR 上限、IntersectionObserver/visibility 暂停、鼠标交互可选。
 */
