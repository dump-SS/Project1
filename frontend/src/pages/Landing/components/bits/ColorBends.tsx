/**
 * ColorBends —— 源自 React Bits（https://reactbits.dev，MIT + Commons Clause：
 * 产品内可用，禁止打包成组件库转售），-TS-TW 变体原样落盘。
 * 用于第二屏 logo 窗背景（2026-09-25 Skyer 指定）：品牌蓝系彩色弯折光带。
 * 裸 three.js 全屏 shader（无 r3f，React 18 兼容已验证：useEffect/useRef only）。
 * 依赖：three；reduced-motion / 触屏由调用方门控。
 */
