/**
 * GradualBlur —— 源自 React Bits（https://reactbits.dev，MIT + Commons Clause：
 * 产品内可用，禁止打包成组件库转售），-TS-TW 变体原样落盘，无落盘改动。
 * 用于页尾页底渐隐（2026-09-25 Skyer 指定）。零依赖（纯 CSS mask + backdrop-filter）。
 */
