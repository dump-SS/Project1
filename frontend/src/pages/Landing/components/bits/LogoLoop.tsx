/**
 * LogoLoop —— 源自 React Bits（https://reactbits.dev，MIT + Commons Clause：
 * 产品内可用，禁止打包成组件库转售），-TS-TW 变体原样落盘。
 * 用于图标海屏（2026-09-25 Skyer 指定）：横向无缝循环，speed/hoverSpeed 可配；
 * LogoItem 支持 node（自定义内容）——本页用 node 渲染「图标 + 功能名」单元格。
 * 零依赖（纯 React + rAF），React 18 兼容已验证。无落盘改动。
 */
