/**
 * Prism —— 源自 React Bits（https://reactbits.dev，MIT + Commons Clause：
 * 产品内可用，禁止打包成组件库转售），-TS-TW 变体源码拷贝进仓库。
 * 用于落地页 Hero 光场（2026-09-25 Skyer 指定，替代 LaserFlow）：ogl raymarch 棱镜光锥。
 * React 18 兼容已验证：纯 hooks，无 r3f / use() / ref-as-prop / Actions；依赖 ogl（已在 deps）。
 *
 * 本仓库改动：无（原样落盘，参数经 props 调；reduced-motion / 触屏由调用方门控，
 * 静态兜底为 CSS 呼吸光晕；suspendWhenOffscreen 开启——滚出视口自动停 rAF）。
 */
