/**
 * DecryptedText —— 源自 React Bits（https://reactbits.dev，MIT + Commons Clause：
 * 产品内可用，禁止打包成组件库转售），-TS-TW 变体原样落盘。
 * 用于功能屏标题入场（2026-09-25 Skyer 指定）：字符解密式揭示，
 * animateOn="view" 由组件内置 IntersectionObserver 在滚动到位置时触发。
 * 依赖：motion（已在 deps）；React 18 兼容已验证。无落盘改动。
 */
