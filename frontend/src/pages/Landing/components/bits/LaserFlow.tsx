/**
 * LaserFlow —— 源自 React Bits（https://reactbits.dev，MIT + Commons Clause：
 * 产品内可用，禁止打包成组件库转售），-TS-TW 变体源码拷贝进仓库。
 * 用于落地页 Hero 光场底光（2026-09-25 Skyer 引入）：品牌蓝光束 + 雾，
 * 裸 three.js 全屏 shader（无 r3f，React 18 兼容已验证：无 use()/ref-as-prop/Actions）。
 *
