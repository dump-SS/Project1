...
# 每个学科的任务模板（topic 颗粒度，不含具体题目，PRD 5.1 边界；key 用拼音学科码）
_SUBJECT_TOPICS = {
    "SX": ["函数与导数 · 巩固", "数列 · 专题", "几何 · 综合训练", "错题回顾"],
    "YY": ["阅读理解 · 限时", "完形填空 · 专项", "写作 · 模板练习", "单词复习"],
    "WL": ["力学 · 综合", "电学 · 专题", "实验题 · 训练", "错题回顾"],
    "HX": ["化学方程式 · 训练", "有机化学 · 专题", "实验题 · 训练", "错题回顾"],
    "SW": ["遗传 · 专题", "细胞 · 巩固", "实验题 · 训练", "错题回顾"],
    "YW": ["文言文 · 精读", "现代文 · 阅读", "作文 · 素材积累", "默写巩固"],
    "LS": ["通史 · 梳理", "专题 · 训练", "材料题 · 分析", "错题回顾"],
    "DL": ["自然地理 · 专题", "人文地理 · 训练", "图表题 · 分析", "错题回顾"],
    "ZZ": ["经济 · 专题", "政治 · 训练", "时政 · 分析", "错题回顾"],
    "other": ["综合 · 训练", "错题回顾"],
}
