...
from routes import assessment, auth, community, daily_summary, error_book, goal, governance, knowledge, knowledge_kb, learning_record, mastery, plan, recommendation, recommendation_content, summary, user, weight
